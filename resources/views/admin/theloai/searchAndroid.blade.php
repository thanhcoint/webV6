...
<div id="page-wrapper">
    <div class="container-fluid">
        <br>
        	<div class="row">
            	<div class="col-lg-12">
            		<div class="row">
                        <form action="admin/Android/search" method="POST">
                    ...
                    <div class="form-group col-lg-2">
                        ...
                        <select class="form-control" name="download_book">
                          <option value="{{$serch->download_book}}">
                               {{$serch->download_book}}
                            </option>
  ...
  <div class="col-sm-1">
   <!-- <a class="btn sbold green" href="admin/Android/download_all"> Download All<i class="fa fa-plus"></i></a> -->
          <form action="admin/Android/download_all" method="POST">
                <input type="hidden" name="_token" value="{{csrf_token()}}"/>
        ...
        <div class="col-sm-1">
        	<form action="admin/Android/delete_all" method="POST">
            <input type="hidden" name="_token" value="{{csrf_token()}}"/>
            <input type="hidden" name="theloai_post" value="{{$theloai}}"/>
            ...
            <tbody>
                @foreach($theloai as $value =>$tl)
                 <td><input type="checkbox" class='checkbox' name='delete' value='{{$tl->id}}' /></td>
                    ...
                    <td>{{$tl->send_mail}}</td>
                    <td>{{$tl->updated_at}}</td>
                    <td class="center"><i class="fa fa-trash-o  fa-fw"></i><a href="admin/Android/delete/{{$tl->id}}"> Delete</a></td>
                   <!-- <td class="center"><i class="fa fa-pencil fa-fw"></i> <a href="admin/Android/sua/">Edit</a></td> -->
                </tr>
                @endforeach
            </tbody>
        </table>
        ...
        $('#delete').click(function(){
           ...
           if (deleteConfirm == true) {
              ...
              if(length > 0){
                 ...
                 // AJAX request
                 $.ajax({
                    url: 'admin/Android/delete_select',
                    type: 'post',
        ...
        $('#download').click(function(){
           ...
           if (deleteConfirm == true) {
              ...
              if(length > 0){
                 ...
                 // AJAX request
                 $.ajax({
                    url: 'admin/Android/download_select',
                    type: 'post',
                    data: {"_token": "{{ csrf_token() }}",user_ids: users_arr},
                    success: function(response){
                        window.location = 'admin/Android/download_select';
                       // Remove <tr>
                       $(".checkbox:checked").each(function(){
                           var userid = $(this).val();
      ...
      $(document).ready(function(){
        ...
        $("#mail_profile").change(function(){
          ...
          //alert(id_mail_profile);
            window.location = 'admin/Android/'+id_mail_profile;
        });
      });
      </script>
      @endsection
