    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="row">
                        <form action="admin/Ipad/search" method="POST">
                ...
                <div class="col-sm-1">
                    ...
                    <form action="admin/Ipad/download_all" method="POST">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}" />
                ...
                <div class="col-sm-1">
                    <a class="btn sbold green" href="admin/theloai/delete_all/{{ $link }}"
        ...
        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
            ...
            <tbody id="data_ajax" name="data_ajax">
                @foreach ($theloai as $value => $tl)
                    ...
                    <td>
                        <p>{{ str_replace(':', ' | ', $tl->OTPGG) }}</p>
                    </td>
                    <td>{{ $tl->send_mail_ipad }}</td>
                    <td>{{ $tl->updated_at }}</td>
                    <td class="center"><i class="fa fa-trash-o  fa-fw"></i><a
                            href="admin/theloai/delete/{{ $tl->id }}"> Delete</a></td>
                    </tr>
                @endforeach
            </tbody>
        </table>
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#mail_profile").change(function() {
                ...
                window.location = 'admin/Ipad/' + id_mail_profile;
            });
        });
