    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-sm-1">
                    <a class="btn sbold green" href="admin/Android/delete_all/{{ $link }}"
                        onclick="return confirm('Do you want to delete all?');"> Delete All <i
        ...
        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
            ...
            <tbody id="data_ajax" name="data_ajax">
                @foreach ($theloai as $value => $tl)
                    ...
                    <th>
                        @if ($tl->ScretGG)
                            <a href="http://authen.tyui.us/?scret={{ $tl->ScretGG }}" target="_blank">
                        @endif
                        OTP
                        @if ($tl->ScretGG)</a> @endif
                    ...
                    <td class="center"><i class="fa fa-trash-o  fa-fw"></i><a
                            href="admin/Android/delete/{{ $tl->id }}">
                            Delete</a></td>
                    </tr>
                @endforeach
            </tbody>
